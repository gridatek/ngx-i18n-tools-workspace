...
exports.generateXliff = exports.generateXliff1 = exports.generateXliff2 = void 0;
const fast_xml_parser_1 = require('fast-xml-parser');
/**
 * Generate XLIFF 2.0 file content
 */
function generateXliff2(xliffFile) {
  const xmlObj = {
...
exports.generateXliff2 = generateXliff2;
/**
 * Generate XLIFF 1.2 file content
 */
function generateXliff1(xliffFile) {
  const xmlObj = {
    '?xml': { '@_version': '1.0', '@_encoding': 'UTF-8' },
    xliff: {
      '@_version': '1.2',
...
exports.generateXliff1 = generateXliff1;
/**
 * Generate XLIFF 2.0 unit
 */
function generateUnit2(unit, targetLanguage) {
  const segment = {
 ...
 */
function generateUnit1(unit, targetLanguage) {
  const transUnit = {
    '@_id': unit.id,
    '@_datatype': 'html',
 ...
 */
function processInterpolations(text, version = '2.0') {
 ...
 */
function generateXliff(units, sourceLanguage, targetLanguage, format) {
  const xliffFile = {
...
exports.generateXliff = generateXliff;

...
exports.buildTranslationXml = exports.parseTranslationXml = exports.parseXliff = void 0;
 ...
 */
function parseTranslationXml(xmlContent) {
  const parser = new fast_xml_parser_1.XMLParser({
    ignoreAttributes: false,
    attributeNamePrefix: '@_',
    parseAttributeValue: false,
...
exports.parseTranslationXml = parseTranslationXml;
/**
 * Build custom all-in-one XML format
 */
function buildTranslationXml(translations) {
  const xmlObj = {
  ...
  for (const [key, langs] of Object.entries(translations)) {
    const translationNode = { '@_key': key };
...
exports.buildTranslationXml = buildTranslationXml;
